...
const cartItems = [
  { 
    ...
    price: 109.00, 
    quantity: 1, 
    image: 'https://via.placeholder.com/80x80/f0f8ff/888888?text=Cake' 
  },
  { 
    id: 2, 
  ...
  { 
    ...
    price: 49.00, 
    quantity: 1, 
    image: 'https://via.placeholder.com/80x80/f0f8ff/888888?text=Pastry' 
  },
];

const shippingEstimate = 20.00;
    ...
    <CartItemCard>
      <Box sx={{ p: 2, display: 'flex', alignItems: 'center' }}>
        <img 
          src={item.image} 
          alt={item.name} 
          style={{ width: 80, height: 80, borderRadius: theme.shape.borderRadius, marginRight: 16, objectFit: 'cover' }}
        />
        <Box sx={{ flexGrow: 1 }}>
          ...
          >
            <Typography variant="caption" color="error" component="span" sx={{ '&:hover': { textDecoration: 'underline' } }}>
              &gt; Remove
            </Typography>
          </Box>
        </Box>
...
const OrderSummary = ({ items }) => {
  ...
  return (
    <SummaryCard>
      ...
      <SummaryRow label="Estimated Total" value={estimatedTotal} isTotal={true} />
      ...
      <Button 
        ...
        sx={{ 
          ...
          backgroundImage: 'linear-gradient(to right, #ffc0cb, #f77f9e)',
          borderRadius: 1 
        }}
      >
        Proceed to Checkout
      ...
      <Container maxWidth="lg">
        ...
        <Box 
          sx={{ 
            ...
            mb: 4, 
            borderRadius: theme.shape.borderRadius,
            backgroundImage: 'linear-gradient(to right, #f77f9e,  #ffc0cb)', // Gradient from your design
            color: 'white' 
          }}
        >
